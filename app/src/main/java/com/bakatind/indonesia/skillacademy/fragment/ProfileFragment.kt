...
import com.bakatind.indonesia.skillacademy.activity.EditProfileActivity
...
import com.bakatind.indonesia.skillacademy.presenter.ProfilePresenter
import com.bakatind.indonesia.skillacademy.util.UtilsConstant.GALLERY_PICK
...
class ProfileFragment : Fragment(), ProfileFragmentView.View {
    ...
    private fun prepare(view: View) {
        ...
        (mContext as AppCompatActivity).supportActionBar?.title = "Profil Pelajar"
